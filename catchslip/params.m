...
ms = 1e-3;
% act_ka = 0.5*ms;                    % integrin activation rate s^-1         
% act_kd = 1e-4*ms;                 % integrin deactivation rate s^-1        
act_ka = 23*ms;  
act_kd = 0.01*ms;  
%sf_kon = 0.41*ms;            % filament recruitment rate s^-1              
...
vincb = 0.65*ms; % s^-1 
trates = [0.018 2.5e-5 4.2e-6 1.7e-8]*ms; % ms^-1, converted to  talin unfolding rates  
FitA = 3309; 			% slip ms  
